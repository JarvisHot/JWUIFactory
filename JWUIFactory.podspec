#
#  Be sure to run `pod spec lint JWUIFactory.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "jarvis🚴"
  # spec.authors            = { "jarvis🚴" => "objectclass@163.com" }
  # spec.social_media_url   = "https://twitter.com/jarvis🚴"
